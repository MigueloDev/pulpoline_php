...
<div class="container py-4">
    <div class="pb-3 mb-4 border-bottom">
      <a href="/create-token" class="d-flex align-items-center text-body-emphasis text-decoration-none">
        ...
        <span class="fs-4">Crear Token</span>
      </a>
    </div>

    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">Crear Token</h1>
        ...
        <form action="/create-token" method="POST">
          ...
          <div class="mb-3">
            <label for="initialSupply" class="form-label">Suministro Inicial</label>
